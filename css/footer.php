    ...
    <div class="container p-4">
        <div class="row">
            <div class="col-lg-6 col-md-12 mb-4 mb-md-0">
                ...
                <p>
                    Nuestra plataforma de comercio electrónico conecta a artesanos de comunidades locales con compradores de todo el mundo. Apoyamos el comercio justo y sostenible.
                </p>
            </div>
            ...
            <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                ...
                <ul class="list-unstyled mb-0">
                    ...
                    <li>
                        <a href="comunidades.php" class="text-white">Comunidades</a>
                    </li>
                    <li>
