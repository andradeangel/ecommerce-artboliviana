        ...
        <nav class="container mx-auto px-6 py-1 flex justify-between items-center">
            ...
            <div class="flex items-center">
                ...
                <div class="relative">
                    ...
                    ?>
                        <a href="<?php echo $dashboard_url; ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" style="text-decoration: none; color: #2d3748; font-weight: 600;">
                            Dashboard
                        </a>
                        <a href="logout.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" style="text-decoration: none; color: #2d3748; font-weight: 600;">
                            Cerrar Sesión
                        </a>
